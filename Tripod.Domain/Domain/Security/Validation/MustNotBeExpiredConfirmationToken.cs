...
{
    public class MustNotBeExpiredConfirmationToken : PropertyValidator
    {
        private readonly IProcessQueries _queries;

        internal MustNotBeExpiredConfirmationToken(IProcessQueries queries)
    ...
    public static class MustNotBeExpiredConfirmationTokenExtensions
    {
        public static IRuleBuilderOptions<T, string> MustNotBeExpiredConfirmationToken<T>
            (this IRuleBuilder<T, string> ruleBuilder, IProcessQueries queries)
        {
            return ruleBuilder.SetValidator(new MustNotBeExpiredConfirmationToken(queries));
        }
    }
}
