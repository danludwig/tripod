...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(Tripod.Services.EntityFramework.EntityDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsdcc81ee323803ee921072b00c71efe956840fa5a8db228721b670d8ab5788227))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySetsdcc81ee323803ee921072b00c71efe956840fa5a8db228721b670d8ab5788227 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "dcc81ee323803ee921072b00c71efe956840fa5a8db228721b670d8ab5788227"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "CodeFirstDatabase.GuestbookEntry")
            {
                return GetView2();
            }

            if (extentName == "EntityDbContext.GuestbookEntries")
            {
                return GetView3();
            }
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for CodeFirstDatabase.GuestbookEntry.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView2()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing GuestbookEntry
        [CodeFirstDatabaseSchema.GuestbookEntry](T1.GuestbookEntry_Id, T1.GuestbookEntry_Text)
    FROM (
        SELECT 
            T.Id AS GuestbookEntry_Id, 
            T.Text AS GuestbookEntry_Text, 
            True AS _from0
        FROM EntityDbContext.GuestbookEntries AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for EntityDbContext.GuestbookEntries.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView3()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing GuestbookEntries
        [Tripod.Services.EntityFramework.GuestbookEntry](T1.GuestbookEntry_Id, T1.GuestbookEntry_Text)
    FROM (
        SELECT 
            T.Id AS GuestbookEntry_Id, 
            T.Text AS GuestbookEntry_Text, 
            True AS _from0
        FROM CodeFirstDatabase.GuestbookEntry AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing Users
        [Tripod.Services.EntityFramework.User](T1.User_Id, T1.User_Name, T1.User_SecurityStamp)
    FROM (
        SELECT 
            T.Id AS User_Id, 
            T.Name AS User_Name, 
    ...
    SELECT VALUE -- Constructing UserClaims
        [Tripod.Services.EntityFramework.UserClaim](T1.UserClaim_Id, T1.UserClaim_UserId, T1.UserClaim_ClaimType, T1.UserClaim_ClaimValue)
    FROM (
        SELECT 
            T.Id AS UserClaim_Id, 
            T.UserId AS UserClaim_UserId, 
    ...
    SELECT VALUE -- Constructing EmailAddresses
        [Tripod.Services.EntityFramework.EmailAddress](T1.EmailAddress_Id, T1.EmailAddress_UserId, T1.EmailAddress_Value, T1.EmailAddress_HashedValue, T1.EmailAddress_IsPrimary, T1.EmailAddress_IsVerified)
    FROM (
        SELECT 
            T.Id AS EmailAddress_Id, 
            T.UserId AS EmailAddress_UserId, 
    ...
    SELECT VALUE -- Constructing LocalMemberships
        [Tripod.Services.EntityFramework.LocalMembership](T1.LocalMembership_Id, T1.LocalMembership_PasswordHash)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Permissions
        [Tripod.Services.EntityFramework.Permission](T1.Permission_Id, T1.Permission_Name, T1.Permission_Description)
    FROM (
        SELECT 
            T.Id AS Permission_Id, 
            T.Name AS Permission_Name, 
    ...
    SELECT VALUE -- Constructing RemoteMemberships
        [Tripod.Services.EntityFramework.RemoteMembership](T1.RemoteMembership_LoginProvider, T1.RemoteMembership_ProviderKey, T1.RemoteMembership_UserId)
    FROM (
        SELECT 
            T.LoginProvider AS RemoteMembership_LoginProvider, 
            T.ProviderKey AS RemoteMembership_ProviderKey, 
    ...
    SELECT VALUE -- Constructing EmailVerifications
        [Tripod.Services.EntityFramework.EmailVerification](T1.EmailVerification_Id, T1.EmailVerification_EmailAddressId, T1.EmailVerification_Token, T1.EmailVerification_Ticket, T1.EmailVerification_Secret, T1.EmailVerification_ExpiresOnUtc, T1.EmailVerification_RedeemedOnUtc, T1.EmailVerification_Purpose) WITH 
        RELATIONSHIP(CREATEREF(EntityDbContext.EmailMessages, ROW(T1.[EmailVerification_Message.EmailVerification_Message_Target.Id]),[Tripod.Services.EntityFramework.EmailMessage]),[Tripod.Services.EntityFramework.EmailVerification_Message],EmailVerification_Message_Source,EmailVerification_Message_Target) 
    FROM (
        SELECT 
            T.Id AS EmailVerification_Id, 
            T.EmailAddressId AS EmailVerification_EmailAddressId, 
            ...
            T.ExpiresOnUtc AS EmailVerification_ExpiresOnUtc, 
            T.RedeemedOnUtc AS EmailVerification_RedeemedOnUtc, 
            CAST(T.Purpose AS [Tripod.Services.EntityFramework.EmailVerificationPurpose]) AS EmailVerification_Purpose, 
            True AS _from0, 
    ...
    SELECT VALUE -- Constructing EmailVerification_Message
        [Tripod.Services.EntityFramework.EmailVerification_Message](T3.[EmailVerification_Message.EmailVerification_Message_Target], T3.[EmailVerification_Message.EmailVerification_Message_Source])
    FROM (
        SELECT -- Constructing EmailVerification_Message_Target
            CreateRef(EntityDbContext.EmailMessages, row(T2.[EmailVerification_Message.EmailVerification_Message_Target.Id]), [Tripod.Services.EntityFramework.EmailMessage]) AS [EmailVerification_Message.EmailVerification_Message_Target], 
        ...
        FROM (
            SELECT -- Constructing EmailVerification_Message_Source
                ...
                CreateRef(EntityDbContext.EmailVerifications, row(T1.[EmailVerification_Message.EmailVerification_Message_Source.Id]), [Tripod.Services.EntityFramework.EmailVerification]) AS [EmailVerification_Message.EmailVerification_Message_Source]
            FROM (
                SELECT 
                    T.EmailMessageId AS [EmailVerification_Message.EmailVerification_Message_Target.Id], 
    ...
    SELECT VALUE -- Constructing EmailMessages
        [Tripod.Services.EntityFramework.EmailMessage](T1.EmailMessage_Id, T1.EmailMessage_EmailAddressId, T1.EmailMessage_From, T1.EmailMessage_Subject, T1.EmailMessage_Body, T1.EmailMessage_IsBodyHtml, T1.EmailMessage_SendOnUtc, T1.EmailMessage_SentOnUtc, T1.EmailMessage_CancelledOnUtc, T1.EmailMessage_LastSendError)
    FROM (
        SELECT 
            T.Id AS EmailMessage_Id, 
            T.EmailAddressId AS EmailMessage_EmailAddressId, 
    ...
    SELECT VALUE -- Constructing User_Permissions
        [Tripod.Services.EntityFramework.User_Permissions](T3.[User_Permissions.User_Permissions_Source], T3.[User_Permissions.User_Permissions_Target])
    FROM (
        SELECT -- Constructing User_Permissions_Source
            CreateRef(EntityDbContext.Users, row(T2.[User_Permissions.User_Permissions_Source.Id]), [Tripod.Services.EntityFramework.User]) AS [User_Permissions.User_Permissions_Source], 
        ...
        FROM (
            SELECT -- Constructing User_Permissions_Target
                ...
                CreateRef(EntityDbContext.Permissions, row(T1.[User_Permissions.User_Permissions_Target.Id]), [Tripod.Services.EntityFramework.Permission]) AS [User_Permissions.User_Permissions_Target]
            FROM (
                SELECT 
