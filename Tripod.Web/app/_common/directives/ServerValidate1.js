...
(function (App) {
    (function (Directives) {
        (function (ServerValidate1) {
            ServerValidate1.directiveName = 'serverValidate1';
            ...
            ServerValidate1.ServerValidateController = ServerValidateController;

            var directiveFactory = function () {
                return [
                    '$http', '$timeout', '$interval', '$parse', function ($http, $timeout, $interval, $parse) {
                        var directive = {
                            name: ServerValidate1.directiveName,
                            restrict: 'A',
                            require: [ServerValidate1.directiveName, 'modelContrib', 'ngModel', '^formContrib', '^form'],
                            ...
                            link: function (scope, element, attr, ctrls) {
                                ...
                                var validateUrl = attr[ServerValidate1.directiveName];
            ...
            ServerValidate1.directive = directiveFactory();
        })(Directives.ServerValidate1 || (Directives.ServerValidate1 = {}));
        var ServerValidate1 = Directives.ServerValidate1;
